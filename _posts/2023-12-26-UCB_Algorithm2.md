...
In the previous [post](/_posts/2023-10-31-UCB-Algorithm.md), I introduced the UCB algorithm and proved its $O \left( \sqrt{KT\log\frac{KT}{\delta}} + K \right)$ regret bound.
